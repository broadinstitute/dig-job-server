...
//   src/components/researchPortal/customComponents/kpVariantSifter/variantSifterRegionPan.js
// Verbatim port; only the imports below were rewritten for the GWAS-CE frontend.
import {
    clampRegionZoom,
    clampRegionViewArea,
    panRegionViewAreaFromDrag,
} from "./regionZoom.js";
import { applyRegionExpand } from "./searchUtils.js";
