...
//   src/components/researchPortal/customComponents/kpVariantSifter/variantSifterGenesColors.js
//
// Deviation: upstream imports resolveGeneType from a sibling
// variantSifterGenesFilter.js (a gene-biotype filter/dropdown module). That
// file is out of scope for task 7 — no task ports it, and nothing else in
// this task's interfaces needs the rest of its contents (type-filtering UI
// helpers). resolveGeneType is inlined here verbatim (it is a single-line
// function) instead of vendoring the whole filter module.
function resolveGeneType(gene) {
