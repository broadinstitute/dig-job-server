    ...
    <div class="pigean-scatter-container">
        ...
        <div v-else class="chart-wrapper">
            ...
            <div
                ...
                ref="tooltipEl"
                class="fixed bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-lg p-3 z-[9999]"
...
const tooltipStyle = computed(() => {
    ...
    if (tooltip.value.showOnLeft) {
        ...
        left = canvasRect.left + tooltip.value.canvasX - tooltipWidth - offset;
    } else {
        // Show tooltip on right side of the point
        left = canvasRect.left + tooltip.value.canvasX + offset;
    }

    const top = canvasRect.top + tooltip.value.canvasY - 10;
